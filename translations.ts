export const translations = {
  en: {
    ...
    "hero.animatedWords": ["the shot", "your art", "your clients", "growth"],
    "hero.subtitle":
      "The ultimate studio and client management platform for photographers to manage clients, bookings, and workflows, all in one beautiful platform.",
  ...
  tr: {
    ...
    "hero.subtitle":
      "Fotoğrafçıların müşterileri, rezervasyonları ve iş akışlarını tek bir harika platformda yönetmeleri için nihai stüdyo ve müşteri yönetimi platformu.",
